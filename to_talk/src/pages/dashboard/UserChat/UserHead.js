...
function UserHead(props) {
    ...
    const [img, setImg] = useState("");
        ...
        useEffect(() => {
            ...
            if (senderId === 1) {
                setNamee("dhruv");
                //setImg("/static/media/avatar-1.0b4704b47d864dc4c429.jpg")
                
            } else if(senderId === 2) {
                setNamee("parth");
                //setImg(`${props.users[props.active_user].profilePicture}`)
            } else {
                setNamee("");
            }
        }, []);
                            ...
                            </div>
                            {
                                props.users[props.active_user].profilePicture !== "Null" ?
                                    <div className="me-3 ms-0">
                                        <img src={pic} className="rounded-circle avatar-xs" alt="chatvia" />
                                    </div>
                ...
                <ModalBody>
                    <div className="text-center p-4">
                        <div className="avatar-lg mx-auto mb-4">
                            <img src={pic} alt="" className="img-thumbnail rounded-circle" />
                        </div>

                        <h5 className="text-truncate">Brown</h5>
            ...
            <Modal tabIndex="-1" isOpen={Videomodal} toggle={toggleVideoModal} centered>
                <ModalBody>
                    <div className="text-center p-4">
                        ...
                        <h5 className="text-truncate">Mehta Parth</h5>
