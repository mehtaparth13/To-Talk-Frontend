...
function LockScreen(props) {
    ...
    document.title = "Lockscreen | To Talk React - Responsive Bootstrap 5 Chat App"
                ...
                <Row className="justify-content-center">
                    <Col md={8} lg={6} xl={5}>
                            ...
                            <CardBody className="p-4">
                                <div className="p-3">
                                    <div className="user-thumb text-center mb-4">
                                        ...
                                        <h5 className="font-size-15 mt-3">{t('Dhruv Vyas')}</h5>
                                    </div>
                        ...
                        <div className="mt-5 text-center">
                            ...
                            <p>© {new Date().getFullYear()} {t('To Talk')}. {t('Crafted with')} <i className="mdi mdi-heart text-danger"></i> {t('by Themesbrand')}</p>
                        </div>
                    </Col>
                </Row>
            </Container>
