...
const Register = (props) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                dispatch(apiError('An error occurred during registration.'));
            }
        },
    });
    ...
    document.title = "Register | To Talk React - Responsive Bootstrap 5 Chat App";
                    ...
                    <Row className="justify-content-center">
                        <Col md={8} lg={6} xl={5}>
                            <div className="text-center mb-4">
                                ...
                                <h4>{t('Register')}</h4>
                                <p className="text-muted mb-4">{t('Get your To Talk account now')}.</p>
                            </div>
...
export default withRouter(connect(mapStateToProps, { apiError })(Register));