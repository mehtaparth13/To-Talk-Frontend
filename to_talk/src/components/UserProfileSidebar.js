...
function UserProfileSidebar(props) {
    console.log(props, "thisss is props ");
                    ...
                    <div className="mb-4 d-flex justify-content-center">
                        {
                            props.activeUser.profilePicture === "Null" ?
                                ...
                                : <img src={props.activeUser.profilePicture} className="rounded-circle avatar-lg img-thumbnail" alt="To Talk" />
                        }
                        ...
                        <Card className="shadow-none border mb-2">
                            ...
                            >
                                ...
                                <div className="mt-4">
                                    ...
                                    <h5 className="font-size-14 mb-0">Ahmedabad, India</h5>
                                </div>
                                ...
                                >
                                    ...
                                    <Card className="p-2 mb-2">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div className="text-left">
                                                    <h5 className="font-size-14 mb-1">{t('Vishesh Doshi')}</h5>
                                                    {/* <p className="text-muted font-size-13 mb-0">{member.status}</p> */}
                                                </div>
                                            </div>
                                        </div>
