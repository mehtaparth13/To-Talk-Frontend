...
const INIT_STATE = {
    ...
    users: [
        ...
        { id : 0, name : "Mishank Bhatt", profilePicture : avatar2, status : "online", unRead : 0, roomType : "contact", isGroup: false, 
            messages: [
                { id: 1, message: "hi", time: "01:05", userType: "receiver", isImageMessage : false, isFileMessage : false },
                { id: 2, message: "hi Mishank", time: "10.00", userType: "sender", isImageMessage : false, isFileMessage : false },
        ...
        { id : 1, name : "Shlok Trivedi", profilePicture : avatar3, status : "away",unRead : "02", isGroup: false,
            messages: [
                { id : 33, isToday : true },
        ...
        { id : 13, name : "General", profilePicture : "Null", unRead : 0, isGroup: true,
            messages: [
                ...
                { id : 2, userName : "Somil Thakore",  message: "Images", time: "12:05", userType: "receiver", isImageMessage : true, isFileMessage : false, imageMessage : [ { image : img6 } ] },
        ...
        { id : 4, name : "Mehta Parth", profilePicture : avatar4, status : "online",unRead : 0, isGroup: false, isTyping : true,
            messages: [
                { id : 1, userName : "Mehta Parth",  message: "Good Morning", time: "10:00", userType: "receiver", isImageMessage : false, isFileMessage : false },
        ...
        { id : 5, name : "Designer", profilePicture : "Null",unRead : "01",  isGroup: true,
            messages: [
                { id : 1, userName : "Mehta Parth",  message: "Hello send project images", time: "12:00", userType: "receiver", isImageMessage : false, isFileMessage : false },
                { id : 33, isToday : true },
                { id : 2, userName : "Somil Thakore",  message: "Images", time: "12:05", userType: "receiver", isImageMessage : true, isFileMessage : false, imageMessage : [ { image : img6 } ] },
        ...
        { id : 6, name : "Somil Thakore", profilePicture : avatar6, status : "away", unRead : 0,  isGroup: false,
            messages: [
                { id : 33, isToday : true },
        ...
        { id : 7, name : "Kacha Vishw", profilePicture : "Null", status : "online", unRead : 0, isGroup: false, isTyping : true,
            messages: [
                { id : 33, isToday : true },
                { id: 1, message: "hi", time: "01:05", userType: "receiver", isImageMessage : false, isFileMessage : false },
        ...
        { id : 8, name : "Patel Fenil", profilePicture : "Null", status : "online", unRead : 0,  isGroup: false,
            messages: [
                { id : 33, isToday : true },
        ...
        { id : 9, name : "Vishesh Doshi", profilePicture : avatar7, status : "away", unRead : 0, isGroup: false,
            messages: [
                { id : 33, isToday : true },
        ...
        { id : 2, name : "Modi Suraj", profilePicture : avatar2, status : "online",unRead : 0, isGroup: false,
            messages: [
                { id : 33, isToday : true },
    ...
    groups : [
        { gourpId : 1, name : "#General", profilePicture : "Null", isGroup : true, unRead : 0, desc : "General Group",
            members : [
                ...
                { userId : 3, name : "Modi Suraj", profilePicture : "Null", role : null },
                { userId : 4, name : "Vishesh Doshi", profilePicture : avatar7, role : null },
                { userId : 5, name : "Yana sha", profilePicture : avatar3, role : null },
                { userId : 6, name : "Somil Thakore", profilePicture : avatar6, role : null },
            ]    
        },
